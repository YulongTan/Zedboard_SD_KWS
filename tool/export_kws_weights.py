...
def main() -> None:
    ...
    parser.add_argument("--txt-out", default="D:/Vitis/USERS/10_Zedboard_audio_in/SD_read/tool/kws_weights.txt", help="Text output file")
    parser.add_argument("--bin-out", default="D:/Vitis/USERS/10_Zedboard_audio_in/SD_read/tool/kws_weights.bin", help="Binary output file")
